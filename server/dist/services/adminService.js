...
const resetPasswordService = (token, newPassword) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield adminRepository_1.adminRepository.findUserByEmail(decoded.email.toLowerCase());
        if (!user) {
            throw new Error('User not found');
        }
        const updatedUser = yield adminRepository_1.adminRepository.updateUserPassword(decoded.email.toLowerCase(), hashedPassword);
        if (!updatedUser) {
...
const updateUserProfile = (userId, userData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return adminRepository_1.adminRepository.save(user);
});
...
const uploadUserImage = (userId, imageUrl) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield adminRepository_1.adminRepository.updateUser(userId, { image: imageUrl });
    if (!user) {
        throw new Error('User not found');
    }
    return user;
