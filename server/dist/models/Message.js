...
const MessageSchema = new mongoose_1.Schema({
    sender: { type: mongoose_1.default.Schema.Types.ObjectId, required: true, refPath: 'senderModel' },
    receiver: { type: mongoose_1.default.Schema.Types.ObjectId, required: true, refPath: 'receiverModel' },
