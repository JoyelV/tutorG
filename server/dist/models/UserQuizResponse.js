...
const userQuizResponseSchema = new mongoose_1.Schema({
...
const UserQuizResponse = mongoose_1.default.model('UserQuizResponse', userQuizResponseSchema);
exports.default = UserQuizResponse;
