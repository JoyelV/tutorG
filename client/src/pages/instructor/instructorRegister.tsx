...
const InstructorRegister: React.FC = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/instructor/register', { username, email, password, role: 'instructor' });
                        ...
                        <Grid container justifyContent="flex-end" sx={{ mt: 3 }}>
                            <Grid item>
                                <Typography variant="body2">
                                    ...
                                    <Button color="secondary" onClick={() => navigate('/instructor')}>
                                        Sign in
                                    </Button>
                                </Typography>
                            </Grid>
