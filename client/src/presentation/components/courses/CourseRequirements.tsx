  ...
  return (
    <div className="py-4">
      ...
      <ul className="list-disc ml-6 mt-2">
        ...
        <li>Access to Figma and Webflow tools.</li>
        ...
        <li>Those looking to reboot their work life and try a new profession that is fun, rewarding, and highly in-demand.</li>
