    ...
    const fetchCourseData = async () => {
      try {
        ...
        const [courseResponse, reviewsResponse] = await Promise.all([
          ...
          adminService.getCourseReviews(courseId),
        ]);
        ...
        if (courseResponse.status === 200) {
          ...
          setSelectedVideoUrl(courseData.trailer)
        } else {
